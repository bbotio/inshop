                                            ...
                                            <div class="col-md-8">
                                                <div class="col-md-10">
                                                    <select id="country" name="country" data-placeholder="${user.address.country!"Choose a Country..."}"
                                                        ...
                                                        <option value="South Georgia and The South Sandwich Islands">SouthGeorgia and The South Sandwich
                                                            Islands
                                                        </option>
                                            ...
                                            <div class="col-md-8">
                                                <div class="col-md-10">
                                                    <div class="checkbox checkbox-success">
                                                        <input id="DHL" name="DHL" type="checkbox">
                                                        <label for="DHL">DHL</label>
                                                    </div>
                                                    <div class="checkbox checkbox-success">
                                                        <input id="EMS" name="EMS" type="checkbox">
                                                        <label for="EMS">EMS</label>
                                                    </div>
                                                    <div class="checkbox checkbox-success">
                                                        <input id="SelfService" name="SelfService" type="checkbox">
                                                        <label onclick="changeStateAddress()" for="SelfService">Self-service</label>
                                                        <span class="help-block">Please provide the address, where buyer can pickup his items</span>
                                                    </div>

                                                    <div class="form-group">
                                                    <#--Select Country-->
                                                        <label for="country-pickup" class="control-label col-md-3">Country</label>
                                                        <div class="col-md-8">
                                                            <div class="col-md-10">
                                                                <select id="country-pickup" name="country-pickup" data-placeholder="${shop.pickUpAddress.country!"Choose a Country..."}"
                                                                        class="select-block-level chzn-select">
                                                                    <option value=""></option>
                                                                    <option value="United States">United States</option>
                                                                    <option value="United Kingdom">United Kingdom</option>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3" for="state-pickup">State or province</label>

                                                        <div class="col-md-8">
                                                            <div class="col-md-10">
                                                                <input type="text" id="state-pickup" name="state-pickup" placeholder="" class="form-control"
                                                                       value="${shop.pickUpAddress.stateOrProvince!""}">
                                                                <span class="help-block">Please provide your state or province</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3" for="city-pickup">City</label>

                                                        <div class="col-md-8">
                                                            <div class="col-md-10">
                                                                <input type="text" id="city-pickup" name="city-pickup" placeholder="" class="form-control"
                                                                       value="${shop.pickUpAddress.city!""}">
                                                                <span class="help-block">Please provide your city</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3" for="address-pickup">Address</label>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3" for="zip-pickup">Zip Code</label>

                                                        <div class="col-md-8">
                                                            <div class="col-md-10">
                                                                <input type="number" id="zip-pickup" name="zip-pickup" placeholder="" class="form-control"
                                                                       value="${shop.pickUpAddress.zip!""}">
                                                                <span class="help-block">Please provide your zip code</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <script type="text/javascript">
                                                        window.onload = function() {
                                                            <#assign isSelfServiceEnabled = false>
                                                            <#list checkedCheckBoxes as checkbox>
                                                                <#if checkbox == 'SelfService'>
                                                                    <#assign isSelfServiceEnabled = true>
                                                                </#if>
                                                                checkCheckBox('${checkbox}', true);
                                                            </#list>

                                                            <#if isSelfServiceEnabled == false>
                                                                disableAddress(true);
                                                            </#if>
                                                        };
                                                    </script>
