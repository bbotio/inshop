...
<@layout.put block="content">
        <h2 class="page-title">Setup <small>your shop</small></h2>
        <div class="row">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane" id="tab1">
                                    <form class="form-horizontal mt-sm" action='' method="POST">
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                <!-- Shop details -->
                                                <label class="control-label col-md-3"  for="shop-details">Shop details</label>
                                                <div class="col-md-8">
                                                    <div class="col-md-10">
                                ...
                                <div class="tab-pane" id="tab3">
                                    <form class="form-horizontal mt-sm" action='' method="POST">
                                        <fieldset>
                                            <div class="form-group">
                                                <!-- Template name -->
                                                <label class="control-label col-md-3"  for="shop-template">Shop template</label>
                                                <div class="col-md-8">
                                                    <div class="col-md-10">
                                                        <select id="shop-template" data-placeholder="Choose shop template" class="select-block-level chzn-select">
                                                            <option value=""></option>
                                ...
                                <div class="tab-pane" id="tab6">
                                    <form class="form-horizontal mt-sm" action='' method="POST">
                                        <fieldset>
                                            <div class="form-group">
                                                <label for="country-select" class="control-label col-md-3">Destination Country</label>
                                ...
                                <div class="tab-pane" id="tab7">
                                    <form class="form-horizontal mt-sm" action='' method="POST">
                                        <fieldset>
                                            <div class="form-group">
                                                <!-- Google Analytics -->
                                                <label class="control-label col-md-3"  for="google-analytics">Google Analytics ID</label>
                                                <div class="col-md-8">
                                                    <div class="col-md-10">
                                                        <input type="text" id="google-analytics" name="google-analytics" placeholder="" class="form-control">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="col-md-10">
                                                        <input type="text" id="shop-tags" name="shop-tags" placeholder="" class="form-control">
                                ...
                                <div class="description ml mr mt-n-md">
                                    <ul class="pager wizard">
                                        ...
                                        <li class="finish" style="display: none">
                                            <button class="btn btn-success pull-right" >Luanch<i class="fa fa-check"></i></button>
                                        </li>
                                    </ul>
                                </div>
                            </div>
